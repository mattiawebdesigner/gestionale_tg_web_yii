...
/**
 * IltPremiIscrizioniSearch represents the model behind the search form of `backend\models\IltIscrizioni`.
 */
class IltPremiIscrizioniSearch extends IltIscrizioni
{
    /**
     * {@inheritdoc}
     */
