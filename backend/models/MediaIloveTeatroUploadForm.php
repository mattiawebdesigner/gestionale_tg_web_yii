...
class MediaIloveTeatroUploadForm extends Model
{
    /**
     * @var UploadedFile
     */
    ...
    public const UPLOAD_DIR = "iloveteatro/media_uploads/";
    
    public function rules()
    {
        return [
            [['mediaFile'], 'file', 'skipOnEmpty' => true, 'extensions' => 'png, jpg, jpeg, gif, jif, webp'],
        ];
    }
