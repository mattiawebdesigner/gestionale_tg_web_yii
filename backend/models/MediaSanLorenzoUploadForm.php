...
class MediaSanLorenzoUploadForm extends Model
{
    /**
     * @var UploadedFile
     */
    ...
    public const UPLOAD_DIR = "sanlorenzo/media_uploads/";
    
    public function rules()
    {
        return [
            [['mediaFile'], 'file', 'skipOnEmpty' => true, 'extensions'=> 'png, jpg, jpeg, gif, pdf', 'checkExtensionByMimeType' => false,],
        ];
    }
