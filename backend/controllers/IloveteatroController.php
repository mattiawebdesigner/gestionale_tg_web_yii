...
class IloveteatroController extends Controller
{
                ...
                'access' => [
                    ...
                    'rules' => [
                        ...
                        [
                            'actions' => [],//All page
                            'allow' => true,
                            'roles' => ['Super User', 'I Love Teatro'],
                        ],
                    ],
                ],
            ]
    ...
    public function actionIscritti(){
        ...
        $festival = IltFestival::find()->where(['anno' => date('Y')])->one();
    ...
    public function actionAlbumUpdate($id = 1){
        ...
        if ($this->request->isPost) {
            ...
            /*if ($album->load($this->request->post()) && $album->save()) {
                Yii::$app->session->setFlash("success", Yii::t('app', 'Galleria salvata con successo'));
                
                return $this->redirect(['slideshow-home', 'id' => $album->id]);
            }*/
        } else {
    ...
    public function actionTicket(){
        $spettacoli = \app\models\IltSpettacolo::find()
                        ->where(['festival' => IltFestival::findOne(['anno' => date('Y')])->id])
